...
if( ! defined( 'WP_HTML5VP_VERSION' ) ) {
	define( 'WP_HTML5VP_VERSION', '2.6.6' ); // Version of plugin
}
...
if( ! defined( 'WP_HTML5VP_PLUGIN_LINK' ) ) {
	define( 'WP_HTML5VP_PLUGIN_LINK', 'https://www.essentialplugin.com/wordpress-plugin/video-gallery-player/?utm_source=WP&utm_medium=video-gallery&utm_campaign=Features-PRO' ); // Plugin link
}
if(!defined( 'WP_HTML5VP_PLUGIN_UPGRADE' ) ) {
	define('WP_HTML5VP_PLUGIN_UPGRADE','https://www.essentialplugin.com/pricing/?utm_source=WP&utm_medium=video-gallery&utm_campaign=Upgrade-PRO'); // Plugin Check link
}
