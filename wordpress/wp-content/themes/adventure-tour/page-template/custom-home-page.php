        ...
        <div class="slider-image-box" data-dot-img="<?php echo esc_url(get_theme_mod('adventure_trekking_camp_slider_images'.$i)); ?>">
          ...
          <div class="slider-content slider-inner  align-self-center">
            ...
            <?php if ( get_theme_mod('adventure_trekking_camp_slider_main_heading'.$i) ) : ?>
              <h1 class="slide-head"><?php echo esc_html(get_theme_mod('adventure_trekking_camp_slider_main_heading'.$i));?></h1>
            <?php endif; ?>
            <div class="row">
              <div class="col-lg-4 col-md-4 col-sm-4 col-4 align-self-center px-0">
                <div class="slider-button my-3">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 col-md-8 col-12">
          <div class="row">
            <?php
              for ( $adventure_tour_s = 1; $adventure_tour_s <= 6; $adventure_tour_s++ ) {
                $adventure_tour_post_mod =  get_theme_mod( 'adventure_tour_services_sec_settigs'.$adventure_tour_s );
                if ( 'post-none-selected' != $adventure_tour_post_mod ) {
                  $adventure_tour_post[] = $adventure_tour_post_mod;
                }
              }
               if( !empty($adventure_tour_post) ) :
              $adventure_tour_args = array(
                'post_type' =>'post',
              ...
              if ( $adventure_tour_post_query->have_posts() ) :
                $adventure_tour_m = 1;
            ?>
            <?php while ( $adventure_tour_post_query->have_posts() ) : $adventure_tour_post_query->the_post(); ?>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="mid-inner-box my-2 text-center text-lg-left text-md-left">
                  <i class="<?php echo esc_attr(get_theme_mod('adventure_tour_mid_section_icon'.$adventure_tour_m)); ?> serv-icon m-auto"></i>
                  <h5 class="serv-head mt-4 mb-2"><?php the_title();?></h5>
                  <p class="serv-txt"><?php echo esc_html(wp_trim_words(get_the_content(),'25') );?></p>
                </div>
              </div>
            <?php $adventure_tour_m++; endwhile;
            wp_reset_postdata();?>
            <?php else : ?>
        ...
        <div class="col-lg-4 col-md-4 col-12 align-self-center">
          <?php if( get_theme_mod('adventure_tour_services_images') != ''){ ?>
            <img class="serv-img" src="<?php echo esc_url(get_theme_mod('adventure_tour_services_images','')); ?>">
          <?php }?>
        </div>
      </div>      
    </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <?php
          ...
          $adventure_trekking_camp_page_query = new WP_Query(array( 'category_name' => esc_html($adventure_trekking_camp_slider_category ,'adventure-tour')));?>
                ...
                <div class="activities-box mb-4">
                  ...
                  <?php if( get_post_meta($post->ID, 'adventure_trekking_camp_trekking_rating', true) ) {?>
                    <div class="rating-box">
                      ...
                      <p class="mb-0"><?php esc_html_e('Rating','adventure-tour'); ?></p>
                    </div>
                  <?php }?>
