...
if ( ! class_exists( 'Adventure_Trekking_Camp_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Adventure_Trekking_Camp_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Adventure_Trekking_Camp_WPTT_WebFont_Loader( $url );
