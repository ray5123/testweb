 ...
 * Control - Switch.
 *
 * @package Adventure Trekking Camp Themes
 */

if( class_exists( 'WP_Customize_Control' ) ) {
	class Adventure_Trekking_Camp_Customizer_Customcontrol_Switch extends WP_Customize_Control {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 'adventure-trekking-camp-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.js', array( 'jquery' ) );

			wp_enqueue_style( 'adventure-trekking-camp-control-switch', trailingslashit( get_template_directory_uri() ) . 'inc/switch/control_switch.css', '', time() );
