...
if ( ! class_exists( 'Travel_Booking_Expert_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Travel_Booking_Expert_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Travel_Booking_Expert_WPTT_WebFont_Loader( $url );
