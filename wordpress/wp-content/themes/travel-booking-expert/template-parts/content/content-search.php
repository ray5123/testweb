...
<div id="post-<?php the_ID(); ?>" <?php post_class('blog-item'); ?>>
	...
	<div class="blog-content">
		<?php 
			...
			the_content( 
					sprintf( 
						__( 'Read More', 'travel-booking-expert' ), 
	...
	<ul class="comment-timing">
		...
		<li><a href="<?php echo esc_url(get_author_posts_url( get_the_author_meta( 'ID' ) ));?>"><i class="fa fa-user"></i><?php echo esc_html_e('By','travel-booking-expert'); ?> <?php esc_html(the_author()); ?></a></li>
	</ul>
</div>