...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  	<button class="tablinks" onclick="vlogger_video_blog_open_tab(event, 'lite_theme')"><?php esc_html_e( 'Setup With Customizer', 'vlogger-video-blog' ); ?></button>
		  	<button class="tablinks" onclick="vlogger_video_blog_open_tab(event, 'block_pattern')"><?php esc_html_e( 'Setup With Block Pattern', 'vlogger-video-blog' ); ?></button>
			<button class="tablinks" onclick="vlogger_video_blog_open_tab(event, 'gutenberg_editor')"><?php esc_html_e( 'Setup With Gutunberg Block', 'vlogger-video-blog' ); ?></button>	
			<button class="tablinks" onclick="vlogger_video_blog_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'vlogger-video-blog' ); ?></button>
		...
		<?php
			$vlogger_video_blog_plugin_custom_css = '';
			if(class_exists('Ibtana_Visual_Editor_Menu_Class')){
				$vlogger_video_blog_plugin_custom_css ='display: block';
			}
		?>
		<div id="lite_theme" class="tabcontent open">
			<?php if(!class_exists('Ibtana_Visual_Editor_Menu_Class')){ 
				$plugin_ins = Vlogger_Video_Blog_Plugin_Activation_Settings::get_instance();
				$vlogger_video_blog_actions = $plugin_ins->recommended_actions;
				?>
				<div class="vlogger-video-blog-recommended-plugins">
				    <div class="vlogger-video-blog-action-list">
				        <?php if ($vlogger_video_blog_actions): foreach ($vlogger_video_blog_actions as $key => $vlogger_video_blog_actionValue): ?>
				                <div class="vlogger-video-blog-action" id="<?php echo esc_attr($vlogger_video_blog_actionValue['id']);?>">
			                        <div class="action-inner">
			                            <h3 class="action-title"><?php echo esc_html($vlogger_video_blog_actionValue['title']); ?></h3>
			                            <div class="action-desc"><?php echo esc_html($vlogger_video_blog_actionValue['desc']); ?></div>
			                            <?php echo wp_kses_post($vlogger_video_blog_actionValue['link']); ?>
			                            <a class="ibtana-skip-btn" get-start-tab-id="lite-theme-tab" href="javascript:void(0);"><?php esc_html_e('Skip','vlogger-video-blog'); ?></a>
			                        </div>
				                </div>
				            <?php endforeach;
				        endif; ?>
			...
			<?php } ?>
			<div class="lite-theme-tab" style="<?php echo esc_attr($vlogger_video_blog_plugin_custom_css); ?>">
		...
		<div id="block_pattern" class="tabcontent">
				        ...
				        <?php if ($vlogger_video_blog_actions): foreach ($vlogger_video_blog_actions as $key => $vlogger_video_blog_actionValue): ?>
				                <div class="vlogger-video-blog-action" id="<?php echo esc_attr($vlogger_video_blog_actionValue['id']);?>">
			                        <div class="action-inner">
			                            ...
			                            <div class="action-desc"><?php echo esc_html($vlogger_video_blog_actionValue['desc']); ?></div>
			                            <?php echo wp_kses_post($vlogger_video_blog_actionValue['link']); ?>
			                            <a class="ibtana-skip-btn" href="javascript:void(0);" get-start-tab-id="gutenberg-editor-tab"><?php esc_html_e('Skip','vlogger-video-blog'); ?></a>
			                        </div>
				                </div>
				            <?php endforeach;
				        endif; ?>
			...
			<?php } ?>
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vlogger_video_blog_plugin_custom_css); ?>">
				<div class="block-pattern-img">
				  	<h3><?php esc_html_e( 'Block Patterns', 'vlogger-video-blog' ); ?></h3>
					<hr class="h3hr">
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vlogger-video-blog'); ?></p>
              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon >> Click Pattern Tab >> Click on homepage sections >> Publish.','vlogger-video-blog'); ?></span></b></p>
              	<div class="vlogger-video-blog-pattern-page">
				    	<a href="javascript:void(0)" class="vw-pattern-page-btn button-primary button"><?php esc_html_e('Add New Page','vlogger-video-blog'); ?></a>
				   </div>
              	...
              	<div class="link-customizer-with-block-pattern">
						...
						<div class="first-row">
							<div class="row-box">
								...
								<div class="row-box2">
									<span class="dashicons dashicons-networking"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_blog_magazine_social_icon_settings') ); ?>" target="_blank"><?php esc_html_e('Social Icons','vlogger-video-blog'); ?></a>
								</div>
							</div>
							<div class="row-box">
								<div class="row-box1">
		...
		<div id="gutenberg_editor" class="tabcontent">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Gutunberg Blocks', 'vlogger-video-blog' ); ?></h3>
				<hr class="h3hr">
				<div class="vlogger-video-blog-pattern-page">
			    	<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Ibtana Settings','vlogger-video-blog'); ?></a>
			    </div>
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = Vlogger_Video_Blog_Plugin_Activation_Woo_Products::get_instance();
				$vlogger_video_blog_actions = $plugin_ins->recommended_actions;
				?>
				<div class="vlogger-video-blog-recommended-plugins">
					    <div class="vlogger-video-blog-action-list">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Woocommerce Products Blocks', 'vlogger-video-blog' ); ?></h3>
				<hr class="h3hr">
				<div class="vlogger-video-blog-pattern-page">
					<p><?php esc_html_e('Follow the below instructions to setup Products Templates.','vlogger-video-blog'); ?></p>
					<p><b><?php esc_html_e('1. First you need to activate these plugins','vlogger-video-blog'); ?></b></p>
						<p><?php esc_html_e('1. Ibtana - WordPress Website Builder ','vlogger-video-blog'); ?></p>
						<p><?php esc_html_e('2. Ibtana - Ecommerce Product Addons.','vlogger-video-blog'); ?></p>
						<p><?php esc_html_e('3. Woocommerce','vlogger-video-blog'); ?></p>

					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','vlogger-video-blog'); ?></span></b></p>
	              	<div class="vlogger-video-blog-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vlogger-video-blog'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','vlogger-video-blog'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
		...
		<div id="theme_pro" class="tabcontent">
		    ...
		    <div class="col-left-pro">
		    	...
		    	<div class="pro-links">
					...
					<a href="<?php echo esc_url( VLOGGER_VIDEO_BLOG_BUY_NOW ); ?>" target="_blank"><?php esc_html_e('Buy Pro', 'vlogger-video-blog'); ?></a>
