jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vlogger_video_blog_plugin_activate_plugin;
    ...
    $(document).on('click', '.vlogger-video-blog-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vlogger-video-blog-plugin-install');
                button.addClass('button-primary vlogger-video-blog-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vlogger-video-blog-recommended-plugins .vlogger-video-blog-activation-note').css('display','block');
    ...
    $(document).on('click', '.vlogger-video-blog-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vlogger-video-blog-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vlogger-video-blog-recommended-plugins').css('display','none');
    });
