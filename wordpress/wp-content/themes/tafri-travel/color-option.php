<?php
	...
	if($tafri_travel_slider_layout == '0'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.1'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.1 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.2'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.2 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.3'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.3 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.4'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.4 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.5'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.5 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.6'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.6 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.7'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.7 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.8'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.8 !important';
		$tafri_travel_custom_css .='}';
		}else if($tafri_travel_slider_layout == '0.9'){
		$tafri_travel_custom_css .='#slider img{';
			$tafri_travel_custom_css .='opacity:0.9 !important';
		$tafri_travel_custom_css .='}';
		}
	...
	if($tafri_travel_show_slider_image_overlay != false){
		$tafri_travel_custom_css .='#slider{';
			$tafri_travel_custom_css .='background-color: '.esc_attr($tafri_travel_color_slider_image_overlay).'!important;';
		$tafri_travel_custom_css .='}';
	}
	...
	$tafri_travel_post_comment_enable = get_theme_mod('tafri_travel_post_comment_enable',true);
	if($tafri_travel_post_comment_enable == false){
		$tafri_travel_custom_css .='#comments{';
			$tafri_travel_custom_css .='display: none !important;';
		$tafri_travel_custom_css .='}';
	}
	
	//scroll to top css
	$tafri_travel_scroll_background_color = get_theme_mod('tafri_travel_scroll_background_color');
	$tafri_travel_custom_css .='.scrollup i{';
	$tafri_travel_custom_css .='background: '.esc_attr($tafri_travel_scroll_background_color).'! important;';
	$tafri_travel_custom_css .='border-color: '.esc_attr($tafri_travel_scroll_background_color).'! important;';
	$tafri_travel_custom_css .='}';

	$tafri_travel_scroll_icon_color = get_theme_mod('tafri_travel_scroll_icon_color');
	$tafri_travel_custom_css .='.scrollup i{';
	$tafri_travel_custom_css .='color: '.esc_attr($tafri_travel_scroll_icon_color).'! important;';
	$tafri_travel_custom_css .='}';

	$tafri_travel_scroll_background_hover_color = get_theme_mod('tafri_travel_scroll_background_hover_color');
	$tafri_travel_custom_css .='.scrollup i:hover{';
	$tafri_travel_custom_css .='background: '.esc_attr($tafri_travel_scroll_background_hover_color).'! important;';
	$tafri_travel_custom_css .='border-color: '.esc_attr($tafri_travel_scroll_background_hover_color).'! important;';
	$tafri_travel_custom_css .='}';

	//Initial Cap
	$tafri_travel_caps_enable = get_theme_mod('tafri_travel_caps_enable', 'false');
	if($tafri_travel_caps_enable == 'true' ){
	$tafri_travel_custom_css .='.page-box .inicap p:nth-of-type(1)::first-letter, .page-box-single .inicap p:nth-of-type(2)::first-letter{';
	$tafri_travel_custom_css .=' font-size: 60px; font-weight: 800;';
	$tafri_travel_custom_css .=' margin-right: 10px;';
	$tafri_travel_custom_css .=' font-family: "Vollkorn", serif;';
	$tafri_travel_custom_css .=' line-height: 1;';
	$tafri_travel_custom_css .='}';
	}elseif($tafri_travel_caps_enable == 'false' ){
	$tafri_travel_custom_css .='.page-box .inicap p:nth-of-type(1)::first-letter, .page-box-single .inicap p:nth-of-type(2)::first-letter {';
	$tafri_travel_custom_css .='display: none;';
	$tafri_travel_custom_css .='}';
	}
