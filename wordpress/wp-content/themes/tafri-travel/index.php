                  ...
                  <div class="carousel-caption">
                    <div class="inner_carousel">
                      ...
                      <?php if( get_theme_mod('tafri_travel_slider_content',true) != ''){ ?>
                        <p><?php $tafri_travel_excerpt = get_the_excerpt(); echo esc_html( tafri_travel_string_limit_words( $tafri_travel_excerpt, esc_attr(get_theme_mod('tafri_travel_slider_excerpt_number','15')))); ?></p>
                      <?php } ?> 
