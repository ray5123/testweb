jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_blog_magazine_plugin_activate_plugin;
    ...
    $(document).on('click', '.vw-blog-magazine-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-blog-magazine-plugin-install');
                button.addClass('button-primary vw-blog-magazine-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-blog-magazine-recommended-plugins .vw-blog-magazine-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-blog-magazine-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-blog-magazine-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-blog-magazine-recommended-plugins').css('display','none');
    });
