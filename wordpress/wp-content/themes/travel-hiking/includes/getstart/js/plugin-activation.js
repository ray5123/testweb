jQuery(document).ready(function($) {
    'use strict';
    var this_obj = travel_hiking_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.travel-hiking-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message travel-hiking-plugin-install');
                button.addClass('button-primary travel-hiking-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.travel-hiking-recommended-plugins .travel-hiking-activation-note').css('display','block');
    ...
    $(document).on('click', '.travel-hiking-plugin-activate', function(event) {
