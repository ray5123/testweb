...
?>
	...
	<div id="content" class="site-content">
		<div class="container">
			...
			<?php bosa_agency_dark_blog_advertisement_banner(); ?>
							...
							<?php
								if( !get_theme_mod( 'disable_pagination', false ) ):
									the_posts_pagination( array(
										...
										'next_text' => '<span>'.esc_html__( 'Next', 'bosa-agency-dark' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'bosa-agency-dark' ) . '</span>',
										'prev_text' => '<span>'.esc_html__( 'Prev', 'bosa-agency-dark' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'bosa-agency-dark' ) . '</span>',
										'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'bosa-agency-dark' ) . ' </span>',
									));
								endif;
								wp_reset_postdata();
							?>
